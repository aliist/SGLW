...
LPCWSTR szClassName     = L"MainWim";
LPCWSTR GLWinClassName  = L"GLWin";
WNDPROC GLWinProc;
HINSTANCE ghInst;
...
WindowHandler    MainWindow, GLWindow, StatusWindow, ToolWindow;
DeviceContext     DC;
GlHandler RC;

MINMAXINFO RAMINMAX;
RECT MainWRect,ToolWRect,StatusWRect,GLWRect,Test;
int WINAPI WinMain(HINSTANCE hThisInstance, HINSTANCE hPrevInstance, LPSTR lpszArgument, int nCmdShow)
{
    WNDCLASSEX   winclex = { 0 };
    ...
    MainWindow = CreateWindowEx(0, szClassName, L"Win", WS_OVERLAPPEDWINDOW | WS_VISIBLE, 0,0,640,480/*CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT*/, NULL, NULL, hThisInstance, NULL);
    if (!MainWindow)
